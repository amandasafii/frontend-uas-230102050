...
<body class="bg-gray-100 font-sans min-h-screen flex items-center justify-center">
  ...
  <div class="bg-white w-full max-w-2xl p-6 rounded-xl shadow-md">
    <h2 class="text-2xl font-bold text-gray-700 mb-6 flex items-center gap-2">
      <i data-feather="plus-circle" class="text-blue-600"></i> Tambah Matkul
    </h2>
    ...
    <form action="{{ route('kelas.store') }}" method="POST" class="space-y-4">
      ...
      <div>
        ...
        <input type="text" name="nama_kelas" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:border-blue-400" required>
      </div>
